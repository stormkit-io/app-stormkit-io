...
export const insertRepo =
  ({ api, provider, history, setState, repo }) =>
  () => {
        ...
        return setState({
          ...
          error: (
            <div>
              ...
              <p>
                Something went wrong, please get in touch with us to get help.
                You can see your contact options by clicking on the menu on the
