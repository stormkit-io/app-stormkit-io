...
import { mockCreateTeam, mockUpdateTeam } from "~/testing/nocks/nock_team";
...
describe("~/layouts/TopMenu/Teams/TeamModal.tsx", () => {
    ...
    const memoryRouter = createMemoryRouter([
      {
        path: "/:team?",
        element: (
          <TeamModal team={team} onClose={onClose} reload={reloadTeams} />
        ),
      },
    ]);
  ...
  describe("edit mode", () => {
    ...
    test("should display header", () => {
      expect(wrapper.getByText("Update Team")).toBeTruthy();
    });
